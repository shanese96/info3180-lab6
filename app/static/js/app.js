    ...
    template:`
        <div class="news">
            ...
            <ul class="news__list" style="margin-top: 2em;">
                <li v-for="article in articles" style="list-style-type: none;display: inline-block;border-radius: 5px;
                border: 1px solid lightgrey;border-top-width: 5px;border-top-color: lightgreen;margin: 0 1em 1em 0;
                box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);width: 18em;height: 30em;
                vertical-align: top;padding: 1em;"class="news__item">
